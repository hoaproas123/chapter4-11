...
class move_scale extends StatefulWidget {
  const move_scale({super.key});

  @override
  State<move_scale> createState() => _move_scaleState();
}

class _move_scaleState extends State<move_scale> {
